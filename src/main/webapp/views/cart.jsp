...
<%--        </div>--%>
        ...
        <div id="content" class="col-sm-9">
            ...
            <form action="https://opencart.templatemela.com/OPC08/OPC080182/index.php?route=checkout/cart/edit" method="post" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <div class="input-group btn-block" style="max-width: 200px;">
                                        ...
                                        <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-danger" onclick="cart.remove('YToxOntzOjEwOiJwcm9kdWN0X2lkIjtpOjQzO30=');">
        ...
        <input type="submit" value="Apply Voucher" id="button-voucher" data-loading-text="Loading..."  class="btn btn-primary" />
            ...
            <div class="buttons">
                <div class="pull-left"><a href="https://opencart.templatemela.com/OPC08/OPC080182/index.php?route=common/home" class="btn btn-default">Continue Shopping</a></div>
                <div class="pull-right"><a href="https://opencart.templatemela.com/OPC08/OPC080182/index.php?route=checkout/checkout" class="btn btn-primary">Checkout</a></div>
            </div>
        </div>
    </div>
</div>
