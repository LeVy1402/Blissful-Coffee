...
<div id="res-menu" class="main-menu nav-container1">
    ...
    <div class="container product">
        <ul class="breadcrumb">
            ...
            <li><a href="products?action=detail&id=${product.getProductId()}">${product.getProductName()}</a></li>
        </ul>
        <div class="row">
            <div id="content" class="productpage col-sm-12">
                    ...
                    <div class="col-sm-8">
                        <div class="product-info">
                            <ul class="left product-image thumbnails">
                                ...
                                <li class="image"><a class="thumbnail" href="/img/${product.getImage()}" title="${product.getProductName()}">
                                    <img src="/img/${product.getImage()}" title="Coffee Bean Direct" alt="${product.getProductName()}" /></a>
                                </li>
                ...
                <li><span style="text-decoration: line-through;">${product.getPrice()}</span><h4>${product.getPrice()} VNĐ</h4></li>
...
<%--                        <input type="submit" type="button" id="button-cart" data-loading-text="Loading..." class="btn btn-primary btn-lg btn-block" value="Add to Cart"></input>--%>
                    ...
                    <button type="button" onclick="cart.add(${product.getProductId()},$('input[name=quantity]').val());" id="button-cart" data-loading-text="Loading..." class="btn btn-primary btn-lg btn-block" > ADD TO CART</button>
                </form>
            </div>

                    <div class="btn-group product">
                <button type="button" class="wishlist_button btn btn-default" id="wishlist" onclick="wishlist.add(${product.getProductId()});"><span class="hidden-xs hidden-sm hidden-md">Add to Wish List</span></button>
<%--                <button type="button" class="compare_button btn btn-default" id="compare" onclick="compare.add('43');"><span class="hidden-xs hidden-sm hidden-md">Add to Compare</span></button>--%>
            ...
            <div class="rating">
                <p>
                    ...
                    <span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i></span>
                    <span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i></span>
                    <a href="#" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;">${reviewList.size()} ${reviewList.size()<2?'review':'reviews'} </a> / <a href="#" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;">Write a review</a>
                </p>
                <hr>
...
<%--                        </div>--%>
                        <div class="buttons">
                            <div class="pull-right">
                                <input type="submit" id="button-review" data-loading-text="Loading..." class="btn btn-primary" value="Send Review"> </input>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div id="products-related" class="related-products">
                ...
                <div class="box-product product-carousel" id="related-carousel">
                    ...
                    <c:forEach items="${productListByCate}" var="product">
                        <div class="slider-item">
                            <div class="product-block product-thumb transition">
                                <div class="product-block-inner">
                                    <div class="image">
                                        <a class="thumbnail" href="products?action=detail&id=${product.getProductId()}">
                                            <img src="/img/${product.getImage()}" alt="Breckfast Blend" title="Breckfast Blend" class="img-responsive" />
                                        </a>
                                    </div>
                                    <div class="caption">
                                        <h4><a href="products?action=detail&${product.getProductId()}">${product.getProductName()}</a></h4>
                                        <div class="hover_block">
                                            <div class="actions">
                                                ...
                                                <button class="wishlist_button" type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add(${product.getProductId()});"></button>
                                        ...
                                        <p class="price">
                                            <span class="price-new">${product.getPrice()} VNĐ</span>
                                        </p>
